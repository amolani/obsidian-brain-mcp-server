...
export class Vault {
  ...
  buildSessionImpactReport(options: BuildSessionImpactReportOptions): SessionImpactReportResult {
    return buildSessionImpactReportService(this, options)
  }

  buildKnowledgeInbox(options: BuildKnowledgeInboxOptions = {}): KnowledgeInboxResult {
    return buildKnowledgeInboxService(this, options)
  }

  brainApplyInboxItem(options: BrainApplyInboxItemOptions): BrainApplyInboxItemResult {
  ...
  buildChangeLedger(options: BuildChangeLedgerOptions = {}): ChangeLedgerResult {
    return buildChangeLedgerService(this, options)
  }
  ...
  recordCalibrationLabel(options: RecordCalibrationLabelOptions): RecordCalibrationLabelResult {
    return recordCalibrationLabelService(this, options)
  }

  recordCalibrationJudgement(
    options: RecordCalibrationJudgementOptions,
  ): RecordCalibrationJudgementResult {
    return recordCalibrationJudgementService(this, options)
  }

  brainCalibrationSummary(): BrainCalibrationSummary {
    return brainCalibrationSummaryService(this)
  }

  brainCalibrationReviewBatch(
    options: BrainCalibrationReviewBatchOptions = {},
  ): BrainCalibrationReviewBatchResult {
    return brainCalibrationReviewBatchService(this, options)
  }
  ...
  brainHealthCheck(options: BrainHealthOptions = {}): BrainHealthResult {
    return brainHealthCheckService(this, options)
  }
