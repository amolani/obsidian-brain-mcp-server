...
export function brainHealthCheck(vault: Vault, options: BrainHealthOptions = {}): BrainHealthResult {
  ...
  const requiredTools = ['brain_auto_build', 'archive_auto_build_run', 'brain_checkpoint', 'brain_metrics', 'record_brain_feedback', 'build_capture_review', 'build_evidence_dashboard', 'build_session_impact_report', 'build_knowledge_inbox', 'brain_apply_inbox_item', 'migrate_brain_metadata', 'build_change_ledger']
