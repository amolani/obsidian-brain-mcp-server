  ...
  beforeEach(async () => {
    ...
    writeNote(vaultPath, {
      ...
      body: attestSessionDigestFixture([
        ...
        '',
        '- [F6] Ist der vollständige Adressbereich des DHCP-Scopes geprüft? _(Salienz 76/100 · Evidenz 67/100 · medium)_',
        '',
        '### Review',
        '',
  ...
  test('auto-promotion requires both salience and evidence', async () => {
    writeNote(vaultPath, {
      ...
      body: attestSessionDigestFixture([
        ...
        '### Entscheidung',
        '',
        '- [F1] Der produktive FQDN muss vor der Umstellung festgelegt werden. _(Salienz 91/100 · Evidenz 67/100 · medium)_',
        '',
        '### Ergebnis',
        '',
  ...
  test('updated captures do not create duplicate concrete knowledge gaps', async () => {
    ...
    writeNote(vaultPath, {
      ...
      body: attestSessionDigestFixture([
        ...
        '### Offene Punkte / Constraints',
        '',
        '- [F1] Ist der vollständige Adressbereich des DHCP-Scopes geprüft? _(Salienz 76/100 · Evidenz 67/100 · medium)_',
        '',
        '### Evidenz',
        '',
